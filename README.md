...
| :--------------------- | :-------------- | :---------------------------------------------------------------------------------------------------- |
| *Project Manager*    | Hadi Syaputra | Mengatur timeline, Kanban, QA fungsional, dan dokumentasi proyek. |
| *Database Analyst*   | Iqbal Ramadhan | Membuat struktur database untuk menyimpan data customer, layanan, dan pesanan |
| *Backend Developer*  | Khairul Raziq | Mengembangkan RESTful API, validasi request, API Resource, dan transaksi database. |
---
